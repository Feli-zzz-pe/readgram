    ...
    <body class="h-full">
        ...
        <nav class="bg-gray-800">
            ...
            <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                ...
                <a href="/livros" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Livros</a>
        ...
        {{--<header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-between">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">{{ $heading }}</h1> <!-- Dashboard -->
